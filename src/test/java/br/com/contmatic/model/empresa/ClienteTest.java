...
public class ClienteTest {
    ...
    void deve_aceitar_cpf_valido() {
        ...
        assertEquals("72738802070", clienteFixture.getCpf());
    }
    ...
    void deve_aceitar_nome_valido() {
        clienteFixture.setNome("João Victor Mendes");
        assertEquals("João Victor Mendes", clienteFixture.getNome());
    }

    @Test
    void deve_aceitar_nome_com_acento() {
        clienteFixture.setNome("José");
        assertThat(getViolation(clienteFixture).size(), is(0));
    }
    ...
    void deve_aceitar_email_valido() {
        ...
        assertEquals("funcionario@gmail", clienteFixture.getEmail());
    }
